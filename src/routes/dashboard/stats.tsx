  ...
  return (
    <div className="flex-1 w-full relative flex flex-col pb-8">
      <div className="w-full relative z-20 py-4 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <h1 className="text-xl sm:text-2xl font-serif font-bold text-stone-800">Thống Kê Gia Phả</h1>
        <p className="text-sm text-stone-500 mt-1">Tổng quan số liệu về dòng họ</p>
      </div>
