        ...
        <div className="w-full max-w-2xl space-y-8">
          <div className="animate-[fade-in-up_0.6s_ease-out_forwards] rounded-3xl border border-white/80 bg-white/70 p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-xl sm:p-10">
            <div className="mb-6 flex items-center gap-3">
              ...
              <h1 className="font-serif text-2xl font-bold text-stone-900 sm:text-3xl">{t('aboutPage.title')}</h1>
            </div>
          ...
          >
            <div className="mb-6 flex items-center gap-3">
              ...
              <h2 className="font-serif text-xl font-bold text-stone-900 sm:text-2xl">{t('aboutPage.securityTitle')}</h2>
            </div>
          ...
          >
            <div className="mb-6 flex items-center gap-3">
              ...
              <h2 className="font-serif text-xl font-bold text-stone-900 sm:text-2xl">{t('aboutPage.contactTitle')}</h2>
            </div>
