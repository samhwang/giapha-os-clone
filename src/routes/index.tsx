  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute top-0 left-0 w-150 h-150 bg-amber-200/20 rounded-full blur-6xl -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute top-1/3 right-0 w-125 h-125 bg-stone-200/20 rounded-full blur-6xl translate-x-1/2" />
      </div>
