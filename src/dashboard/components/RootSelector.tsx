    ...
    <div className="relative w-full sm:w-72" ref={dropdownRef}>
      ...
      >
        ...
        <div className="min-w-0 flex-1 text-left">
          <p className="mb-0.5 text-2xs leading-none font-bold tracking-widest text-stone-400 uppercase">
            {t("nav.rootDisplay")}
          </p>
                      ...
                      <div className="min-w-0 flex-1 text-left">
                        <p
                          className={cn(
                            ...
                            isSelected
                              ? "font-bold"
                              : "font-medium group-hover/item:text-stone-900",
                          )}
                        >
                          {person.fullName}
                        </p>
                        {person.generation != null && (
                          <p className="text-2xs font-medium text-stone-400">
