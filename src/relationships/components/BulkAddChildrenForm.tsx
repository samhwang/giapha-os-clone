      ...
      <div className="space-y-4">
        <div>
          ...
          <select
            ...
            className={cn(INPUT_BASE, 'flex-1 rounded-md p-2 text-sm focus:border-sky-500 focus:ring-sky-500 sm:rounded-lg sm:p-2.5')}
          >
        ...
        <div className="space-y-2">
          <span className="mb-1 block text-xs font-medium text-stone-500">{t('relationship.childrenList')}</span>
          {bulkChildren.map((child, index) => (
            ...
            <div key={index} className="flex items-center gap-2">
              ...
              <input
                ...
                className={cn(INPUT_BASE, 'flex-2 rounded-md p-2 text-sm focus:border-sky-500 focus:ring-sky-500')}
              />
              <select
                value={child.gender}
                onChange={(e) => {
                ...
                className={cn(INPUT_BASE, 'flex-1 rounded-md p-2 text-sm focus:border-sky-500 focus:ring-sky-500')}
              >
              ...
              <input
                ...
                className={cn(INPUT_BASE, 'w-24 flex-1 rounded-md p-2 text-sm focus:border-sky-500 focus:ring-sky-500')}
              />
              <input
                type="number"
                ...
                className={cn(INPUT_BASE, 'w-16 rounded-md p-2 text-sm focus:border-sky-500 focus:ring-sky-500')}
              />
              <button
                type="button"
                onClick={() => {
