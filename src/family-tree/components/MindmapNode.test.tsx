...
function buildAdj(
  spouses: Map<string, SpouseData[]> = new Map(),
  children: Map<string, import("../../members/types").Person[]> = new Map(),
): AdjacencyLists {
...
describe("MindmapNode", () => {
  ...
  it("renders spouse when person has a marriage relationship", () => {
    ...
    const spousesByPersonId = new Map<string, SpouseData[]>([
      ["p1", [{ person: spouse, note: null }]],
    ]);
