    ...
    <div className="relative w-full sm:w-72" ref={dropdownRef}>
      ...
      >
        ...
        <div className="flex-1 min-w-0 text-left">
          <p className="text-[10px] font-bold text-stone-400 uppercase tracking-widest leading-none mb-0.5">Gốc hiển thị</p>
          <p className="truncate text-stone-800 font-semibold select-none leading-tight">{currentRootPerson ? currentRootPerson.fullName : 'Chọn người...'}</p>
        </div>
            ...
            <div className="overflow-y-auto flex-1 p-1.5">
              {filteredPersons.length > 0 ? (
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0 text-left">
                          ...
                          {person.generation != null && <p className="text-[10px] text-stone-400 font-medium">Đời thứ {person.generation}</p>}
                        </div>
                ...
                <div className="px-4 py-8 text-center flex flex-col items-center justify-center gap-2">
                  ...
                  <div className="text-sm font-medium text-stone-600">Không tìm thấy kết quả</div>
