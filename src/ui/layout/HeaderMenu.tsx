  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="flex items-center gap-2 pl-2 pr-4 py-1.5 rounded-full hover:bg-stone-100 transition-all duration-fast border border-transparent hover:border-stone-200"
      >
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-border-default py-2 z-50 overflow-hidden animate-[scale-in_0.15s_ease-out_forwards]">
