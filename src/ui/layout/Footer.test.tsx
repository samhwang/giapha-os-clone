...
describe("Footer", () => {
  it("renders GitHub link", () => {
    ...
    expect(screen.getByText("Gia Phả OS").closest("a")).toHaveAttribute(
      "href",
      "https://github.com/samhwang/giapha-os-clone",
    );
  });
  ...
  it("renders Sam Huynh link", () => {
    ...
    expect(screen.getByText("Sam Huynh").closest("a")).toHaveAttribute(
      "href",
      "https://me.samh.page",
    );
  });
