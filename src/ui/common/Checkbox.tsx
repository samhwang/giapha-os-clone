  ...
  return (
    <label className="group flex items-center gap-3">
      <div className="relative flex items-center">
        ...
        <div className={cn('flex size-5 items-center justify-center rounded border-2 border-stone-300 transition-colors', checked && colorClass)}>
          {checked && (
      ...
      <span className={cn('text-sm font-semibold text-stone-700 transition-colors', hoverClass)}>{label}</span>
    </label>
  );
}
