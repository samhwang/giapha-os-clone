...
export function getAvatarBg(gender: string): string {
  return cn(
...
export function getAvatarSize(size: 'sm' | 'md' | 'lg' = 'md'): string {
  return cn(
...
export function getAvatarSizeLarge(): string {
  return cn(
...
export function getGenderAvatarLarge(gender: string): string {
  return cn(
    'h-24 w-24 sm:h-32 sm:w-32 rounded-full border-4 sm:border-[6px] border-white flex items-center justify-center text-3xl sm:text-4xl font-bold text-white overflow-hidden shadow-xl shrink-0',
    gender === Gender.enum.male && 'bg-linear-to-br from-sky-400 to-sky-700',
    gender === Gender.enum.female && 'bg-linear-to-br from-rose-400 to-rose-700',
...
export function getInLawBadgeStyle(gender: string): string {
  return cn(
...
export function getInLawBadgeStyleDetail(gender: string): string {
  return cn(
...
export function getBlurBgStyle(gender: string): string {
  return cn(
